...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">南京邮电大学高性能计算与大数据处理研究所</div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item left-align"><a href="">首页</a></li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="./booklist.jsp" target="content"><i class="layui-icon layui-icon-read"
                                                                          style="font-size: 16px; color: #1E9FFF;"></i>
                        模型管理</a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="./sortlist.jsp" target="content"><i class="layui-icon layui-icon-tabs"
                                                                          style="font-size: 16px; color: #1E9FFF;"></i>
                        数据集管理</a>
                </li>
                <li class="layui-nav-item">
