...
<script type="text/html" id="headBar">
    <button type="button" class="layui-btn  layui-btn-sm" lay-event="add"><i class="layui-icon">添加数据集</i></button>
</script>

<!-- 表格后面的操作 -->
<script type="text/html" id="operateBar">
    <%--		<a class="layui-btn layui-btn-xs " lay-event="">查看数据集</a>--%>
    <a class="layui-btn layui-btn-xs" lay-event="model-data-list">查看数据集</a>
    <a class="layui-btn layui-btn-xs" lay-event="add-model-data">添加数据</a>
