...
<%--                <option value="id">ID</option>--%>
                ...
                <option value="description">模型描述</option>
            </select>
        </div>
        <div class="layui-inline">
        ...
        <button type="button" class="layui-btn  layui-btn-sm" lay-event="add"><i class="layui-icon">添加模型</i>
        </button>
    </div>
</script>
...
<script type="text/html" id="operateBar">
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="bookBorrowList">查看模型</a>
    ...
    layui.use(['table', 'jquery'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[
                ...
                , {field: 'name', title: '模型名称', width: 170, sort: true}
